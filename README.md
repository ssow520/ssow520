...
### [SkillSwap](https://github.com/ssow520/skillswap) — Marketplace freelance
> Angular 19 · Node.js · MongoDB · REST API · JWT

Plateforme full-stack mettant en relation clients et freelancers, connectée à une API REST en production sur DigitalOcean. Système de rôles dynamique, CRUD complet, authentification JWT et routing guards Angular.
...
### BudgetMaster Mobile — Application .NET MAUI
> .NET 9 · C# · MVVM · SQLite · Design Patterns

Application mobile multi-plateforme avec dark UI, **7 design patterns** implémentés (Repository, Factory, Observer…), architecture MVVM stricte et persistance SQLite.
...
**DEC — Techniques de l'informatique** · Collège LaSalle, Montréal *(2023 – présent)*
Spécialisation programmeur-analyste · Design patterns, développement mobile, bases de données, tendances technologiques

---

<div align="center">

*Disponible pour un stage en développement — printemps/été 2026*
